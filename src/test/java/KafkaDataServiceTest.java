import com.bank.datageneratormicroservice.KafkaProApplication;
...
@SpringBootTest(classes = KafkaProApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
